...
\State suffscore $\gets \psi(q,q',a) \,\otimes$ suffscore
...
\State suffscore $\gets \psi(S,B,t) \,\otimes$ suffscore
\If{suffscore $>$ maxscore}
\State maxscore $\gets$ suffscore
...
en arbre va recalculer au moins deux foix la valeur du préfixe {\sl N Cl V}. 
...
(Viterbi, Dijkstra ou toute approximation gloutonne).
...
Une autre famille importante de modèles locaux sont constitués par des réseaux de neurones à propagation avant (ou récurrents) dont
...
Notons que d'autres modèles peuvent être utilisés de manière locale, ainsi il est courant d'utiliser des
 modèles à large marge de type perceptron comme des modèles locaux plutôt que dans leur version structurée.
