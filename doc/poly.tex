...
\begin{displaymath}
score(G) = \sum_{(i,j) \in E} score(i,j,\mathbf{x})
\end{displaymath}
...
\section{Incomplete trees}
L'algo essaye de trouver la meilleure projection $i\stackrel{*}{\rightarrow} j$ (ou $j\stackrel{*}{\rightarrow} i$ ) 
pour un span donné. On remarque que le gouverneur $i$ (ou $j$) pourrait avoir une projection qui continue à droite de $j$ (resp. $i$).

Trees whose governor projection might be extended at the dependent.
...
Either the highest weighted tree spanning $\langle s,t \rangle$ is an incomplete tree just discovered or it is an incomplete tree of shorter span that needs to be completed.

\begin{dependency}
\begin{deptext}[column sep=.5cm]
w$_i$ \& w$_u$ \&  w$_j$ \\
\end{deptext}
  \depedge[hide label,edge unit distance=1.25ex,edge style={ultra thick,dotted}]{1}{3}{ } 
  %\depedge[hide label,edge style={ultra thick,dotted}]{1}{2}{ }
  %\depedge[hide label]{2}{3}{ }
\end{dependency}
\begin{dependency}
\begin{deptext}[column sep=.5cm]
w$_i$ \& w$_u$ \&  w$_j$ \\
\end{deptext}
  %\depedge[hide label,edge style={ultra thick,dotted}]{1}{3}{ } 
  \depedge[hide label,edge style={ultra thick,dotted}]{1}{2}{ }
  \depedge[hide label]{2}{3}{ }
\end{dependency}
...
w$_i$ \& w$_u$ \&  w$_j$ \\
\end{deptext}
  \depedge[hide label,edge unit distance=1.25ex,
  edge style={ultra thick,dotted}]{3}{1}{ } 
  %\depedge[hide label,edge style={ultra thick,dotted}]{1}{2}{ }
  %\depedge[hide label]{2}{3}{ }
\end{dependency}
\begin{dependency}
...
\end{deptext}
  %\depedge[hide label,edge style={ultra thick,dotted}]{1}{3}{ } 
  \depedge[hide label]{2}{1}{ }
  \depedge[hide label,edge style={ultra thick,dotted}]{3}{2}{ }
\end{dependency}
